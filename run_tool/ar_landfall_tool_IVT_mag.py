...
class landfall_tool_IVT_magnitude:
    ...
    def create_figure(self):
        ...
        fname1 = '../figs/{0}/{1}_LandfallTool_{2}_{3}_current'.format(self.loc, self.forecast, self.mag_type, self.ptloc)
        fname2 = '../figs/{0}/{1}_LandfallTool_{2}_{3}_{4}'.format(self.loc, self.forecast, self.mag_type, self.ptloc, self.date_string)
        fmt = 'png'
